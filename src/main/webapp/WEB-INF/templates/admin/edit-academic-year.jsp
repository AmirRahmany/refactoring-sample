                    ...
                    <c:if test="${showEditPanel != false}">
                        ...
                        <form action="${pageContext.request.contextPath}/admin/EditAcademicYear" method="post" id="editForm">
                            ...
                            <table class="form-table">
                                <tr>
                                    <td class="form-label">کد سال:</td>
                                    <td>${yearId}</td>
                                </tr>
                                <tr>
                                    <td class="form-label required">نام سال تحصیلی:</td>
                                    <td>
                                        <input type="text" name="yearName" value="${yearName}" class="form-control" required />
                                        <c:if test="${not empty yearNameError}">
                                            <span style="color: red" class="invalid-feedback">${yearNameError}</span>
                                        </c:if>
                                    </td>
                                </tr>
                                <tr>
...
<script>
    function confirmDelete() {
        return confirm('آیا از حذف این سال تحصیلی اطمینان دارید؟');
    }
