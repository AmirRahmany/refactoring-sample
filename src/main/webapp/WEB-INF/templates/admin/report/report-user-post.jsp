...
<head>
    ...
    <title>گزارش پست‌های کاربران</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="post">
                <div class="entry">
                    ...
                    <c:if test="${isAuthenticated}">
                        <form action="${pageContext.request.contextPath}/admin/reports/users/by-posts" method="post" id="reportForm">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                            <table class="form-table">
                                <tr>
                                    <td>
                                        <input type="checkbox" name="checkUser" id="checkUser" ${checkUser ? 'checked' : ''} />
                                        <label for="checkUser">انتخاب کاربر :</label>
                                    </td>
                                    <td>
                                        <select name="listUsers" id="listUsers" class="form-control">
    ...
    (function () {
        ...
        if (form) {
            form.addEventListener('submit', function (event) {
                const userChecked = document.getElementById('checkUser').checked;
                const userSelect = document.getElementById('listUsers');
                ...
                if (userChecked && userSelect.selectedIndex === -1) {
